...
class _TransferPindahBukuPageState extends State<TransferPindahBukuPage> {
  DateTime _selectedDate = DateTime.now();
  File? _image;
  final picker = ImagePicker();

  String? _selectedDariBukuKas;
  String? _selectedKeBukuKas;
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              value: _selectedDariBukuKas ?? _bukuKasList[0],
            ...
            DropdownButtonFormField<String>(
              ...
              value: _selectedKeBukuKas ?? _bukuKasList[0],
              items: _bukuKasList.map((buku) {
                return DropdownMenuItem(
                  value: buku,
                  child: Text(buku, style: GoogleFonts.poppins()),
